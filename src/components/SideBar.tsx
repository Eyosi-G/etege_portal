...
const SideBar = () => {
  ...
  const menus = <div className='space-y-4'>
    ...
    />
    {userData && ["ADMIN"].includes(userData.role) && <SideBarItem
      to='/sales-person'
      text='Sales Persons'
      icon={
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
  ...
  return (
    <>
      <div className='bg-gray-100 rounded-t-lg py-4 px-2 justify-end flex md:hidden'>
        ...
        {openMenu && <button onClick={() => setOpenMenu(false)} >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
      ...
      <div>
        <div className='md:hidden '>
          {openMenu && <div className='bg-gray-50 py-4 px-2 rounded-b-lg'>{menus}</div>}
        </div>
